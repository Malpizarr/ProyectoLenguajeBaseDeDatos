--------------------------------------------------------
--  File created - Saturday-July-20-2024   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "MALPZ"."INVENTARIO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 3 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence PEDIDO_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "MALPZ"."PEDIDO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 23 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence PRODUCTOS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "MALPZ"."PRODUCTOS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 2 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "MALPZ"."SEQ_ID_MENSAJES_CONTACTO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 3 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence USUARIOS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "MALPZ"."USUARIOS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 5 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
;
--------------------------------------------------------
--  DDL for View VISTA_ESTADOS_PEDIDOS
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "MALPZ"."VISTA_ESTADOS_PEDIDOS" ("ID_ESTADO", "NOMBRE_ESTADO", "DESCRIPCION", "FECHA_CREACION") AS 
  SELECT e.id_estado, e.nombre_estado, e.descripcion, e.fecha_creacion
...
SET DEFINE OFF;
Insert into MALPZ.INVENTARIO (ID_INVENTARIO,ID_PRODUCTO,CANTIDAD,ULTIMA_ACTUALIZACION) values (2,30,50,to_timestamp('20-JUL-24 05.24.27.000000000 PM','DD-MON-RR HH.MI.SSXFF AM'));
...
SET DEFINE OFF;
Insert into MALPZ.PRODUCTOS (ID_PRODUCTO,ID_CATEGORIA,NOMBRE,PRECIO,FECHA_CREACION) values (30,30,'Smartphone',299.99,to_timestamp('20-JUL-24 05.23.22.000000000 PM','DD-MON-RR HH.MI.SSXFF AM'));
REM INSERTING into MALPZ.USUARIOS
SET DEFINE OFF;
Insert into MALPZ.USUARIOS (ID_USUARIO,NOMBRE_USUARIO,CONTRASENA,CORREO_ELECTRONICO,ROL,FECHA_CREACION) values (30,'usuario30','password','usuario30@correo.com','cliente',to_timestamp('20-JUL-24 05.23.22.000000000 PM','DD-MON-RR HH.MI.SSXFF AM'));
--------------------------------------------------------
...
BEGIN
    INSERT INTO usuarios (nombre_usuario, contrasena, correo_electronico, rol, fecha_creacion)
    VALUES (p_nombre_usuario, p_contrasena, p_correo_electronico, p_rol, SYSDATE);
END crear_usuario;
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "MALPZ"."LISTAR_TODAS_LAS_CATEGORIAS_PRODUCTOS" IS
    CURSOR cur_categorias IS SELECT * FROM categorias_productos;
    v_categoria categorias_productos%ROWTYPE;
BEGIN
    OPEN cur_categorias;
    LOOP
        FETCH cur_categorias INTO v_categoria;
        EXIT WHEN cur_categorias%NOTFOUND;
        DBMS_OUTPUT.PUT_LINE('ID: ' || v_categoria.id_categoria || ' Nombre: ' || v_categoria.nombre);
    END LOOP;
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "MALPZ"."LISTAR_TODOS_LOS_PRODUCTOS" IS
...
BEGIN
    FOR pedido IN (SELECT * FROM pedidos WHERE id_usuario = p_id_usuario)
        LOOP
            DBMS_OUTPUT.PUT_LINE('ID: ' || pedido.id_pedido || ' Total: ' || pedido.total);
        END LOOP;
...
BEGIN
    SELECT nombre_usuario, contrasena, correo_electronico, rol, fecha_creacion
    INTO p_nombre_usuario, p_contrasena, p_correo_electronico, p_rol, p_fecha_creacion
    FROM usuarios
    WHERE id_usuario = p_id_usuario;
END obtener_usuario;
